...
public class ImportTestes {
    ...
    public ImportTestes(String resource, String format, int count) throws URISyntaxException {
        this.format = format;
        this.count = count;
        this.file = Paths.get(ImportTestes.class.getResource(resource).toURI());
    }
